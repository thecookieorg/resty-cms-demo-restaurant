...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { facebook: @social.facebook, instagram: @social.instagram, twitter: @social.twitter }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { facebook: @social.facebook, instagram: @social.instagram, twitter: @social.twitter }
    assert_redirected_to social_path(assigns(:social))
  end
